...
\address{
	\begin{tabbing}
	\textbf{Home} Darwin College, University of Cambridge,\\
	Silver St, Cambridge CB3 9EU, UK\\\\
	\textbf{Office} FN06, William Gates Building,\\
	...
	\textbf{Email} : 
	\mbox{  \\ \tt
	%\href{mailto:d.manousakas@gmail.com}{d.manousakas@gmail.com}}\\
	\href{mailto:dm754@cl.cam.ac.uk}{dm754@cam.ac.uk}}\\
  	\mbox{\small\tt \url{https://www.cl.cam.ac.uk/~dm754}} \\
	\mbox{\small\tt \url{https://uk.linkedin.com/in/dionmanousakas}} \\
...
%\begin{category}{Personal Information}
%\citem{Birthdate}: 08/09/1989
%\citem{Nationality}: Greek
%\citem{Military Service}: Fulfilled
%\end{category}
...
\vspace{-.5cm}
\newline 
\textsc{University of Cambridge, Darwin College}\\
\textbf{Doctor of Philosophy (Ph.D.), Department of Computer Science \& Technology}, \emph{Oct. 2016 - Oct. 2020 (expected)}. \\
 Research Topic: 
 \emph{&Data Summarizations for Scalable and Privacy-Aware Learning \\&in High Dimensions}\\ 
...
\textbf{Master of Science~(MSc) in Machine Learning}}, \emph{Nov. 2015}  (Distinction).  \\
...
Thesis title: \emph{Longitudinal Analysis of International Trade Data based on Network Theory and Machine Learning}\\
Supervisor: Dr Michael T. Schaub (Imperial College London) \\

\newline
\textsc{National Technical University of Athens} \\
\textbf{Diploma in Electrical \& Computer Engineering}, (5-years degree), \emph{Sept. 2014} (GPA: 8.66/10.0 - Top 8\%)  \\ 
...
Stipend awarded by MPI.\\
Advisor: Dr. Manuel Gomez-Rodriguez  
\newline
...
%$\bullet$ 2016 \citem{  Fully Funded PhD Studentship}, Nokia Bell Labs \\
...
%
%    \textbf{Dr. Mark Herbster}\\
%    Lecturer, Dept. of Computer Science\\
%    University College London\\
%        66 Gower Street (GS3.02)\\
%        London WC1E 6BT,
%        UK \\
%    \Letter\ \href{mailto:M.Herbster@cs.ucl.ac.uk}{M.Herbster@cs.ucl.ac.uk} \\
%    Phone : +44 (0)20 3108 7091
%
%    
%\end{minipage}
%\begin{minipage}[t]{0.45\columnwidth}
...
%    University College London\\
%        66 Gower Street (GS3.08)\\
%        London WC1E 6BT,
%        UK \\
%    \Letter\ \href{mailto: S.Zhou@cs.ucl.ac.uk }{S.Zhou@cs.ucl.ac.uk } \\
%    Phone : +44 (0)20 3108 7088
