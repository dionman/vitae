...
\vspace{-.5cm}
\newline 
	\textsc{University of Cambridge, Darwin College} \hfill \textbf{2016 --  Present}\\
\textbf{Doctor of Philosophy (Ph.D.), Department of Computer Science \& Technology}, \\\emph{Submission in Oct. 2020 (expected)} \\
\begin{align*}
...
\textbf{Master of Science~(M.Sc.) in Machine Learning}},  Distinction \hfill \textbf{2014 --  2015}  \\
...
\citemnobullet Large-scale Machine Learning; Automated Bayesian inference; Variational methods; Differential privacy; High-dimensional data analysis; Information geometry; Trustworthy and Robust inference; Point Processes; Uncertainty quantification; Active learning; Data valuation
...
\citemnobullet $\bullet$~\textbf{D. Manousakas}, Z.D. Xu, C. Mascolo, T. Campbell. \emph{Bayesian Pseudocoresets}, Advances in Neural Information Processing Systems 33, 2020 
...
$\bullet$ 2\ts{nd} UK Mobile, Wearable and Ubiquitous Systems Research Symposium, Computer Laboratory, Oxford, UK, September, 2019\\
