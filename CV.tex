...
\textbf{Doctor of Philosophy (Ph.D.), Department of Computer Science \& Technology}, \\\emph{Submission in Oct. 2020 (expected)} \\
 Research Topic: 
 \emph{Data Summarizations for Scalable and Privacy-Aware Learning in \mbox{High Dimensions}}\\ 
isor: Prof. Cecilia Mascolo \\
...
\citemnobullet Large-scale Machine Learning; Automated Bayesian inference; Variational methods; High-dimensional statistics; Differential privacy; Information geometry; Trustworthy and Robust inference; Point Processes; Uncertainty quantification; Active learning; Data valuation
