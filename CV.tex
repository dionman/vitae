...
\textbf{Doctor of Philosophy (Ph.D.), Department of Computer Science \& Technology}, \\\emph{Submitted in Oct. 2020; successfully defended in Dec. 2020} \\ 
\begin{align*}
...
\begin{category}{Internships \& Employment}
	...
	Research on privacy loss caused by information diffusion over networks, using multidimensional temporal point processes. Stipend awarded by MPI.  Advisor: Dr. Manuel Gomez-Rodriguez  
\newline
...
\citemnobullet Large-scale Machine Learning; Probabilistic Modeling and Bayesian Inference; Stochastic Optimization; Variational Methods; Differential Privacy; Information Geometry; Point Processes; Submodularity; Uncertainty Quantification; Dynamical Systems; Active Learning; AutoML; Bayesian Optimization; Adaptive Experimentation; Trustworthy Inference and Robust Statistics

%\noindent\rule{\textwidth}{0.2pt}
\end{category}

\begin{category}{Publications}
\citemnobullet $\bullet$~\textbf{D. Manousakas}, C. Mascolo. \emph{$\beta$-Cores: Robust Large-Scale Bayesian Data Summarization in the Presence of Outliers}, Proceedings of the 14th ACM International Conference on Web Search and Data Mining, 2021.%. \emph{arXiv}, 2020 (Under submission)

\citemnobullet $\bullet$~\textbf{D. Manousakas}, Z. Xu, C. Mascolo, T. Campbell. \emph{Bayesian Pseudocoresets}, Advances in Neural Information Processing Systems, 2020. 
...
\citemnobullet $\bullet$~\textbf{D. Manousakas}, C. Mascolo, A.R. Beresford, D. Chan, N. Sharma. \emph{Quantifying Privacy Loss of Human Mobility Graph Topology}, Proceedings on Privacy Enhancing Technologies, Volume 2018(3): 5-21.
...
\citemnobullet 
\textsc{Talks \& Conferences Attended}\\
$\bullet$ Guest talk on "Bayesian Coresets for Private and Robust Large-Scale Inference", Auton Lab---The Robotics Institute, Carnegie Mellon University,  April 2021\\
$\bullet$ 14th ACM International WSDM Conference, Virtual, March 2021\\
$\bullet$ 34th Conference on Neural Information Processing Systems, Virtual, December 2020\\
